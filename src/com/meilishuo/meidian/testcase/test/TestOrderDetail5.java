 ...
 */
public class TestOrderDetail5 extends BaseClass {
    ...
    public void testOrderDetail4(){
        ...
        //点击退款单
        solo.clickOnText("退款单");
        Log.d(TAG,"点击退款单");
        solo.sleep(1000);

        //点击订单
        solo.waitForView(solo.getView(OrderPage.image,0));
        solo.sleep(2000);
        ...
        assertTrue(solo.waitForView(solo.getView(OrderDetailPage.refund)));
        assertTrue(CommonMethod.get_text(solo,OrderDetailPage.refund,0).equals("退款成功"));
